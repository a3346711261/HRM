...
public interface UserCompanyPersonalDao extends JpaRepository<UserCompanyPersonal, String>, JpaSpecificationExecutor<UserCompanyPersonal> {
    ...
    //WHERE time_of_entry LIKE '2018-03%' OR (b.resignation_time LIKE '2018-02%')
    //LEFT JOIN EmployeeResignation b on a.userId=b.userId where a.companyId=?1 and a.timeOfEntry like?2
