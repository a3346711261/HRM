...
import com.ihrm.common.utlis.DownloadUtils;
...
public class EmployeeController extends BaseController {
    ...
    public void export(@PathVariable String month) throws Exception {
        //1.获取报表数据
        month = month.replace("2020","2018");
        month = month.replace("3","03");
        ...
        //创建行
        //标题
        String [] titles = "编号,姓名,手机,最高学历,国家地区,护照号,籍贯,生日,属性,入职时间,离职类型,离职原因,离职时间".split(",");
        //处理标题
